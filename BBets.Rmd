...
print (money)
```
The number of student to make the payout fair is 28
...
In conclusion Mr Brownlow has to change the number of students and  of his payout against the dollar
